    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (batteryManager != null) {
                ...
                Intent intent = getApplicationContext().registerReceiver(null, tempFilter);
                int chargingInt = intent.getIntExtra(BatteryManager.EXTRA_STATUS, 0);
                if ((chargingInt == BatteryManager.BATTERY_STATUS_CHARGING) || (chargingInt == BatteryManager.BATTERY_STATUS_FULL)) {
                    isCharging = true;
                } else {
                    isCharging = false;
                }
