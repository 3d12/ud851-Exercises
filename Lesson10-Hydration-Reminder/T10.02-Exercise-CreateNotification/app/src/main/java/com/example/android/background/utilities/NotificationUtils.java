...
public class NotificationUtils {
    ...
    private static final int PENDINGINTENT_ID = 44;

    @TargetApi(26)
    public static void remindUserBecauseCharging(Context context) {
        String channelId = "com.example.android.background.utilities.NotificationUtils.Channel1";
        ...
        if (notificationManager != null) {
            ...
            builder.setContentTitle(resources.getString(R.string.charging_reminder_notification_title));
            builder.setContentText(resources.getString(R.string.charging_reminder_notification_body));
            builder.setStyle(new NotificationCompat.BigTextStyle().bigText(resources.getString(R.string.charging_reminder_notification_body)));
