...
public class NotificationUtils {
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        return new NotificationCompat.Action.Builder(NotificationCompat.BADGE_ICON_NONE, "NOPE", pendingIntent).build();
    }
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context,
                ...
                intent,
                PendingIntent.FLAG_CANCEL_CURRENT);
        return new NotificationCompat.Action.Builder(NotificationCompat.BADGE_ICON_NONE, "DONE", pendingIntent).build();
    }
