...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void loadColorFromPrefs(SharedPreferences sharedPreferences) {
        String selectedValue = sharedPreferences.getString(getString(R.string.pref_color_list_key),
                getString(R.string.pref_color_red_value));
        Log.d("loadColorFromPrefs", "The color that was selected is " + selectedValue);
        mVisualizerView.setColor(selectedValue);
    }
